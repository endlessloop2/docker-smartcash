...
ENV VERSION ${VERSION:-1.1.1}
RUN wget -O /tmp/${COMPONENT}.tar.gz "https://github.com/SmartCash/smartcash/releases/download/v${VERSION}/smartcash-${VERSION}-x86_64-linux-gnu.tar.gz" \
    && cd /tmp/ \
